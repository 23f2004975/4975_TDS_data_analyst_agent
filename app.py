...
from services import PIL_AVAILABLE

load_dotenv()
from config import logger

app = FastAPI(title="4975 TDS DA Agent")


from config import _GEMINI_KEYS,  _MODEL_HIERARCHY
import time
from services import parse_keys_and_types,agent_executor, clean_llm_output, write_and_run_temp_python
...
async def analyze_data(request: Request):
    try:
        ...
        if not questions_file:
            raise HTTPException(400, "Questions file missing (.txt)")
